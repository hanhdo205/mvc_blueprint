    ...
    <ul class="nav navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right">
          ...
          <a class="dropdown-item" href="logout?token=<?php echo md5("signout".date("dmH"))?>" onclick="return confirm('<?php echo T_('Do you really want to logout?');?>');">
	  ...
	  <div class="container-fluid">
		<div class="animated fadeIn">
		  <div class="card">
			...
			<div class="card-body">
				<?php echo sprintf(T_("This is an admin page - %s"),$testVar);?>
				</div>
		  </div>
		</div>
      </div>
